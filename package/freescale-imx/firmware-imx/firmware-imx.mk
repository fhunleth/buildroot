...
define FIRMWARE_IMX_INSTALL_IMAGE_DDR_FW
	# Create padded versions of lpddr5_{d,i}mem_* and generate lpddr5_fw.bin.
	...
	$(call FIRMWARE_IMX_PREPARE_DDR_FW, \
		...
		lpddr5_fw)
	$(call FIRMWARE_IMX_PREPARE_DDR_FW, \
		lpddr5_imem_qb_v202311,
		lpddr5_dmem_qb_v202311,
		lpddr5_qb_fw)
	cat $(FIRMWARE_IMX_DDRFW_DIR)/lpddr5_fw.bin \
		$(FIRMWARE_IMX_DDRFW_DIR)/lpddr5_qb_fw.bin > \
		$(BINARIES_DIR)/lpddr5_fw.bin
	ln -sf $(BINARIES_DIR)/lpddr5_fw.bin $(BINARIES_DIR)/ddr_fw.bin
	...
	# the binary dir.
	cp $(FIRMWARE_IMX_DDRFW_DIR)/lpddr5*.bin $(BINARIES_DIR)/
endef
endif
